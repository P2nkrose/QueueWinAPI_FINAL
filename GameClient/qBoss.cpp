...

{
	...
	m_Collider->SetScale(Vec2(130.f, 190.f));
	...
	// DEAD
	m_Animator->CreateAnimation(L"BossDeadLeft", pBossDeadLeft, Vec2(0.f, 0.f), Vec2(300.f, 310.f), 29, 10);
	m_Animator->CreateAnimation(L"BossDeadRight", pBossDeadRight, Vec2(0.f, 0.f), Vec2(300.f, 310.f), 29, 10);
